...
public class TC03 extends Capability{
	...
	public static LanguagePOM langPom = null;
	@BeforeTest
	public void beforeTest() throws IOException {
		...
		langPom=new LanguagePOM(driver);
	...
	{
		Thread.sleep(5000);
		System.out.println("In select language");
		Thread.sleep(5000);
		langPom.Scrollnclick().click();
		langPom.English().click();
